...
quicktunnel() {
    # --- START: 插入的 DNS 設定程式碼 ---
    echo "--- 正在強制設定 DNS 為 8.8.8.8 / 8.8.4.4 ---"
    ...
    if [ "$OPERA" = "1" ]; then
        ...
        # 將 Opera Proxy 的輸出重定向到 /dev/null
